...
1. **Planejamento:** Levantamento das principais perguntas de negócio que precisavam ser respondidas.
2. **ETL:**
    - Tratamento de valores nulos e duplicadas;
    - Padronização de nomes de colunas e remoção de espaços vazios;
    - Conversão dos tipos de dados;
    - Feature Engineering:
3. **Análise Exploratória:** Criação de análises estatísticas e protótipos de gráficos no Jupyter Notebook usando a biblioteca *Plotly*.
4. **Desenvolvimento do Dashboard em Streamlit:**
    - Estruturação do código em arquivosmodulares
...
Em dias de Festival, o tempo médio de entrega sofre um aumento drástico, e o desvio padrão cresce proporcionalmente, indicando que a frota atual não consegue absorver o pico de demanda.


> **2. Densidade do Trânsito**
A maior parte do volume de pedidos ocorre nos horários de trânsito moderado a alto. A empresa poderia para captar mais entregadores nesses horários durante a semana.

> **3. Distância vs. Tempo de Preparo**
Em certas cidades, principalmente urbanas e semi-urbanas, mesmo com distâncias médias menores o tempo total de entrega é maior. Possivelmente trânsito urbano pesado, condições do trânsito ou na demora do preparo no restaurante. É cabível investigar os trajetos para propor novas rotas de entrega
...
- **Filtros Dinâmicos:** Filtros dinâmicos em cada página de visualização.
- **Indicadores de Desempenho:** Topo de cada página com as métricas mais críticas.
