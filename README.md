# Cury Company - Dashboard de Operações e Logística

## 1. O Problema de Negócio

**O que é a Cury Company?**
A Cury Company é uma empresa de tecnologia focada em logística e entrega de comida (*food delivery*). O seu modelo de negócio atua como Marketplace, sendo um intermediário que conecta clientes, restaurantes e entregadores parceiros, garantindo que os pedidos cheguem de forma rápida e segura aos consumidores.
...
Através dos dados da Cury Company, é possível monitorar a saúde operacional da empresa, entender os gargalos logísticos e avaliar o desempenho da frota de entregadores.
...
- **Visões Abordadas:** O projeto focou-se em três visões principais:
    ...
    2. **Visão Entregadores:** Métricas de avaliação por idade, impacto das condições climáticas e trânsito, e ranking de velocidade (Top mais rápidos/lentos).
...
O produto final é um **Dashboard de Operações Interativo** alojado na nuvem, acessível a partir de qualquer navegador web.

**Funcionalidades do App:**

- **Filtros Dinâmicos:** O utilizador pode filtrar todos os painéis escolhendo uma janela de datas e selecionando cenários específicos de trânsito (Low, Jam, High, Medium).
- **Indicadores de Desempenho (KPIs):** Visibilidade imediata no topo de cada página com as métricas mais críticas (Entregadores Ativos, Distância Média, Avaliações Médias).
- **Mapas Interativos:** Visualização geográfica , permitindo o zoom e a análise da densidade de entregas por região.

🔗 **Link para o Dashboard:** [Acessar a Aplicação Web Cury Company](https://currycompany-project.streamlit.app/)

---

## 6. Conclusão e Próximos Passos

O objetivo era criar um dashboard que pudesse ser utilizado de fato como uma ferramenta gerencial. O Dashboard da Cury Company permite à liderança observar a operação sob diferentes ângulos, identificando os possíveis pontos de melhoria e pontos positivos.
